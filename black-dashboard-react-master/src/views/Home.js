        ...
        <div className="home__wrapper">
            ...
            <header className="home__main-layout">
                <div className="home__main-layout--right">
                    ...
                    <p>
                        My Wallet (our friends call us MW) is a free, client-side interface helping you interact with the mycoin blockchain. Our easy-to-use, open-source platform allows you to generate wallets, interact with smart contracts, and so much more.
                    </p>
                </div>
            ...
            <section className="home__options">
                <button onClick={handleCreateWallet} className="home__options--button">
                    <img width="87" src="https://www.myetherwallet.com/img/create-wallet.73282ac1.png" alt="wallet" />
                    <div className="home__options--button-container">
                        <h2>Create A New Wallet</h2>
                        <p> Generate your own unique my coin wallet. Receive a public address (0x...) and choose a method for access and recovery. </p>
                        <h4>Get started </h4>
                    </div>
                </button>
                <button onClick={() => {
                    ...
                    <img width="87" src="https://www.myetherwallet.com/img/unlock-wallet.3f0ec389.png" alt="wallet" />
                    <div className="home__options--button-container">
                        <h2>Access My Wallet</h2>
                        <p> Get the keystore.txt from your PC.This is not a recommended way to access your wallet. These options should only be used in offline settings by experienced users. </p>
                        <h4>Access Now</h4>
                        <input onChange={handleGetFileStore} ref={refInput} style={{ display: "none" }} type="file" accept=".txt" />
                    </div>
                </button>
            </section>
